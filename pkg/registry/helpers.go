...
func UpdateAssetRecord(db *gorm.DB, asset *Asset) error {
	if asset.Checksum == "" {
...
func AttachTags(db *gorm.DB, asset *Asset, tags []*Tag) error {
...
func DetachTags(db *gorm.DB, asset *Asset, tags []*Tag) error {
...
func CreateTagRecord(db *gorm.DB, name string) (*Tag, error) {
...
func GetTagRecord(db *gorm.DB, name string) (*Tag, error) {
...
func GetTagRecordAssets(db *gorm.DB, name string, limit int, offset int) ([]*Asset, error) {
...
func GetTagRecordById(db *gorm.DB, id uint) (*Tag, error) {
...
func GetTagsByNames(db *gorm.DB, names []string) ([]*Tag, error) {
...
func ListAssetsRecords(db *gorm.DB, opts ...SearchAssetsOption) ([]*Asset, error) {
...
func CreateDatasetRecord(db *gorm.DB, name string, description string) (*Dataset, error) {
...
func CreateDatasetVersionRecord(db *gorm.DB, datasetName string, versionDisplay string, description string) (*DatasetVersion, error) {
...
func CreateAssetRecords(db *gorm.DB, assets ...*Asset) error {
